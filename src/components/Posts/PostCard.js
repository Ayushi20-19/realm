            ...
            <div className='rounded-md shadow-md sm:w-96 bg-coolGray-900 text-coolGray-100'>
              ...
              <div className='p-3  '>
                <p className='text-sm mb-1'>
                  ...
                  Molestiae ad repudiandae quasi error animi dolores. Excepturi
                  velit illo perspiciatis exercitationem blanditiis placeat
                  laborum. Aperiam, placeat nesciunt quae quam eum unde!
                </p>
                <img
